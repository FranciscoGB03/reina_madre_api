            ...
            <table bgcolor="#ffffff" .class="content" align="center" cellpadding="0" cellspacing="0" border="0"
                        ...
                        <table width="70" align="left" border="0" cellpadding="0" cellspacing="0">
                            <tr>
                                <td height="70" style="padding: 0 20px 20px 0;">
                                    <img class="fix" src="{{ $message->embed(public_path() . '/img/logo.png') }}" width="70" height="70" border="0"
                        ...
                        <table width="115" align="left" border="0" cellpadding="0" cellspacing="0">
                            <tr>
                                <td height="115" style="padding: 0 20px 20px 0;">
                                    <img class="fix"
                                         src="https://images.unsplash.com/photo-1565079477805-5f8164bc86f5?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=334&q=80"
                                         width="115" height="115" border="0" alt="" style="height: auto;">
                                </td>
                            </tr>
                        </table>
                        <!--[if (gte mso 9)|(IE)]>
                ...
                <tr>
                    <td class="innerpadding bodycopy"
                        style="padding: 30px 30px 30px 30px;color: #153643;font-family: sans-serif;font-size: 16px;line-height: 22px; word-break:break-all;">
                        {{trans('mails.ac4')}}
                        <br/>
